...
document.addEventListener('DOMContentLoaded', () => {
	const callingCardModal = document.getElementById('callingCardModal') as Nullable<HTMLDivElement>;
	const closeButton = document.querySelector('.calling-card-modal .close-button') as Nullable<HTMLSpanElement>;
	const introVideoContainer = document.getElementById('introVideoContainer') as Nullable<HTMLDivElement>;
	const introVideo = document.getElementById('introVideo') as Nullable<HTMLVideoElement>;
	const body = document.body as HTMLBodyElement;
	const skipIntroButton = document.getElementById('skipIntroButton') as Nullable<HTMLButtonElement>;
